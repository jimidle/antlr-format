...
```bash
java -jar antlr-format-cli/target/antlr-format-cli-1.0.3.jar --add-options path/to/Grammar.g4
```
...
```bash
java -cp antlr-format-core/target/antlr-format-core-1.0.3.jar \

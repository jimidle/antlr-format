...
For the `1.0.3` release, the tarball URL is:

```text
https://github.com/jimidle/antlr-format/releases/download/v1.0.3/antlr-format-cli-1.0.3.tar.gz
```
...
- a stable release version (`1.0.3`)
